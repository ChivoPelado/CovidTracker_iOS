...
//                        .cornerRadius(10)
//                    
//                    Button("Prueba / Sospecha Negativa", action: {eliminarCasoDlg.toggle()})
//                        .frame(maxWidth: .infinity)
//                        .padding()
...
//                        .padding(.bottom, 20)
//                    
//                    Button(defineBtnTexto(), action: {nuevoGeoregistro = true})
//                        .frame(maxWidth: .infinity)
//                        .padding()
...
//                .padding(50)
//            }
//            .sheet(isPresented: $nuevoGeoregistro) {
//                NuevaGeoView(nuevoGeoregistro: $nuevoGeoregistro,
//                             casos: $casos,
//                             token: $userToken,
